...
//    println("Root product: $x1x2")
    val x: Int = 7
    val result: Int = sqr(x)
    println("result = $result --> $x * $x = $result")
}
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = sqrt((abs(x1-x2).pow(2.0) + abs(y1-y2).pow(2.0)))
